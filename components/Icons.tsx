...
export const DomoIcon: React.FC<IconProps> = ({ className }) => (
...
export const GSheetIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="currentColor" viewBox="0 0 24 24">
        <path d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm-1 9h-2v2h2v-2zm0 4h-2v2h2v-2zm-4-4H7v2h2v-2zm0 4H7v2h2v-2z" />
    </svg>
);
